...
Ler `templates/skills/catalogo.md` pra ver se alguma das tarefas mencionadas já é coberta por uma skill nativa do Claude Code ou validada pelo B-O-S. Se sim, sugerir a skill existente em vez de criar uma nova:
